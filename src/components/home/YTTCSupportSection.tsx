      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto mb-16">
          <div className="relative bg-secondary/50 rounded-full p-2 flex">
            {/* Sliding Background */}
            <div 
              className={`absolute top-2 bottom-2 w-1/2 bg-background rounded-full shadow-card transition-all duration-500 ease-out ${
                activeTab === 'post' ? 'left-[calc(50%-0.25rem)]' : 'left-2'
              }`}
            />
            ...
            <button
              ...
              className={`relative z-10 flex-1 flex items-center justify-center gap-3 py-4 px-6 rounded-full transition-all duration-300 ${
                activeTab === 'pre' 
                  ? 'text-foreground' 
            ...
            >
              <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                activeTab === 'pre' ? 'bg-primary/20' : 'bg-transparent'
              }`}>
            ...
            >
              <div className={`w-10 h-10 rounded-full flex items-center justify-center transition-all duration-300 ${
                activeTab === 'post' ? 'bg-primary/20' : 'bg-transparent'
              }`}>
