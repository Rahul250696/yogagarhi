...
const iconHighlights = [
  { icon: Award, title: "Yoga Alliance Certified", subtitle: "RYS 300" },
  { icon: Leaf, title: "Multi-Style Yoga", subtitle: "Advanced Teaching" },
  { icon: Heart, title: "Prakriti-Based", subtitle: "Personalized Learning" },
  { icon: Users, title: "Small Batch", subtitle: "6-8 Students" },
  { icon: BookOpen, title: "Traditional + Practical", subtitle: "Complete System" },
  { icon: MapPin, title: "Bali Immersion", subtitle: "28-Day Retreat" },
];
...
export default function Course300Hour() {
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Quiz Section",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Free Manual Button",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Download Syllabus",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Webinar Section",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Pre-YTTC Section",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Book a Call Section",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Enrollment Popup",
    ...
    try {
      await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...
          source: "Course 300 Hour - Quick Enquiry Popup",
